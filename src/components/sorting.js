...
// 2. Обновляем переменные field и order данными из нажатой кнопки
field = action.dataset.field; // Получаем имя поля для сортировки (например, date или total)
order = action.dataset.value; // Получаем новое н
